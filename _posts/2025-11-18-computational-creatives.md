---
title: "Abundant Novice Programmability and the Rise of Computational Creativity"
date: 2025-11-18
author: "Mattias Rost"
---

For most of the history of computing, programming has been a scarce skill.
A skill practiced by a small group of experts who could translate ideas into instructions a machine could execute. That scarcity created a creativity bottleneck: if you couldn’t program, your computational imagination was limited to whatever applications were already available.
...
Editing an excel file for the umpth time.
...
LLM-based code generation makes those tasks cheap. Not financially, but *cognitively*.
They become feasible for anyone who can describe what they want.
...
LLMs handle none of this reliably.
They assist, but they don’t reason deeply about complexity, scale, or systems.
...
These are not “apps” in the traditional sense.
They are computational *expressions*—micro-tools, situated artefacts, small experiments.
Ephemeral, contextual, and deeply personal.
...
*programming as expertise* → *computational creation as expression*

The long tail of “not worth the time” becomes the long tail of *everyday computational imagination*.

People will make things they’ve never made before, because now they can.
Tasks that were once impossible become casual.
Computation becomes a normal medium of thought.
...
*abundant, conversational, everyday computing*.

A world where people routinely reshape computation to fit their lives, not the other way around.

(And while I'm building my envisioned [LLM-mediated computing paradigm](https://interactions.acm.org/archive/view/september-october-2025/reclaiming-the-computer-through-llm-mediated-computing), this is already happening in other ways.)
